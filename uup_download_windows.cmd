@echo off
:: Generated on 2024-11-15 19:01:46 GMT
...
:START_PROCESS
title 26100.2448_amd64_en-gb_multi_5a1853ef download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=5a1853ef-d285-4946-a1fa-7ca4f5bc10d8&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=5a1853ef-d285-4946-a1fa-7ca4f5bc10d8&pack=en-gb&edition=core;professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
